...
class MyDropzone extends React.Component {
  onDrop = (acceptedFiles, rejectedFiles) => {
    if (acceptedFiles.length !== 0) {
      ...
      this.props.enqueueSnackbar('Nieobsługiwany format lub rozmiar pliku (>10 MB).', { variant: 'error' })
    }
  }
  ...
  render() {
    ...
    return (
      <Dropzone maxSize={10240000} onDrop={this.onDrop} multiple={false} accept=".jpg,.jpeg,.png,.tif ">
